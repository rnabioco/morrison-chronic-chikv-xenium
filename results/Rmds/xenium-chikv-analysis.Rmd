...
typ_clrs <- typ_clrs[names(typ_clrs) != "unassigned"]

main_clrs <- assign_colors(
  typ_clrs,
  names  = main_types,
  filter = "colorblind"
)
...
typ_clrs <- set_names(
  unname(typ_clrs[!typ_clrs %in% main_clrs]),
  typs[!typs %in% c(main_types, "unassigned")]
)

typ_clrs <- append(main_clrs, typ_clrs)
typ_clrs[c("unassigned", "other")] <- "#999999"
