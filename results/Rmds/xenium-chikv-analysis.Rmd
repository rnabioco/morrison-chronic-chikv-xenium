...
Cell-cell interaction enrichment is shown for each biological replicate for CHIKV+ macrophages.
Each highlighted bar represents a cell type that showed increased (positive enrichment) or decreased interaction with CHIKV+
macrophages.
Bars are colored based on whether the interacting cells were positive or negative for CHIKV RNA (CHIKV+, CHIKV-).
For example a blue bar labeled as "Macrophages" would represent the interaction between CHIKV+ and CHIKV- macrophages.
Grey bars represent cell-cell interactions that did not include CHIKV+ macrophages.
